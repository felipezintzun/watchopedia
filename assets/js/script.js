...
var getNameSearch = function (name) {
  var apiUrl = 'https://imdb-api.com/en/API/SearchName/k_rsdlji1y/' + name;
...
var getMovieSearch = function (name) {
  var movieUrl = 'https://imdb-api.com/en/API/SearchMovie/k_rsdlji1y/' + name;
...
var movieInfo = function (movieId) {
  ...
  var movieUrl =
    'https://imdb-api.com/en/API/SearchMovie/k_rsdlji1y/' + movieId;
...
var actorInfo = function (actorId) {
  ...
  var apiUrl = 'https://imdb-api.com/en/API/Name/k_rsdlji1y/' + actorId;
